...
print(xtable(descMembershipTable), type = 'html', html.table.attributes = 'style="border-spacing:20px 5px;"', include.rownames=FALSE)
```
...
```{r detailTable, echo=FALSE, result='asis'}
