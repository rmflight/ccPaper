...
Generate gene samples for many different sets of GO terms, using the same criteria as above.
...
testGOSample <- sflapply(seq(1, nSample), {
  goSample(hsGO, nGO, goLimits, nSample=2, nGene=1000, nNoise=500)
})
